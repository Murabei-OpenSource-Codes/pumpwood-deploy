...
class TwitterOpenCrawler:
    ...
    def create_deployment_file(self):
        ...
        deployment_puller_text_formated = deployment_puller_text.format(
                repository=self.repository, version=self.version_puller)
        ...
        if self.firewall_ips and self.postgres_public_ip:
            ...
            list_return.append({
                'type': 'services',
                'name': 'crawler__twitter_open__services_loadbalancer',
